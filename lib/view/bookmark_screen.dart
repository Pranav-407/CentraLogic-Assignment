...
class _BookmarkScreenState extends State<BookmarkScreen> {
  ...
  Widget _buildBookmarkedMovies() {
    ...
    return Column(
      children: bookmarkedMovies.map((movie) => _buildMovieListItem(movie)).toList(),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: Icon(Icons.bookmark, color: Color(0xFFD4AF37)),
            onPressed: () {
              setState(() {
